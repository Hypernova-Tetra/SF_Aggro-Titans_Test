...
* Restored unused alternate Cyloop Counter animation.
* Slightly overhauled his "immediateActions" parameters and some attack params.
* Phase 2 can now be skippable
* Added an effect during Giganto's laser charge shot in "Sp02"
* Super Sonic's death scene is updated to fix a detail on Giganto in where his pillars originally didn't show up.
...
* Adjusted attack parameters, Wyvern will attack multiple times. Chase will active after the player fails to parry Wyvern's attacks 2 times in Phase 1 (when not in Extreme Mode).
...
* Updated Wyvern's Grand Slam in Phase 2 to show the pillars when they originally weren't shown.
* New animation for Grand Slam in Phase 2 in Master King's Trial.
* Wyvern will perform a new QTE after the Phase 2 cutscene if you're on Master King's Trials.
* The Chase in Phase 2 has been pushed back to after all of Wyvern's attacks cycle through, or if the player fails to parry his attacks 4 times (when not in Extreme Mode).
...
* Super Sonic's death cutscene is updated.
* Adjusted "ShieldRide01\_Short" QTE
...
* Unused Sword Attacks restored.
* Unused damage parry for Knight restored.
...
* Unused "ShieldRide02\_aerial" QTE restored, will play after Knight's Phase 2 cutscene in Master King's Trials.
* Knight's final QTE has been adjusted to include a restored unused animation of Super Sonic preparing to catch the sword.
* Knight's final QTE in Battle Rush has a different animation.

# Supreme (Rifle01) {Base Game}

* Restored unused Giganto Clap-Bite QTE (AT\_Sp01)
* Restored and updated the animation of unused Giganto Mega Laser QTE (AT\_Sp02)
* Restored unused Counter-Blow Attack
* Supreme's attacks are slightly faster.
* Supreme's attack patterns may change midway through Phase 1 in Battle Rush and Another Story.
...
* Bitlaser event is converted to a QTE and will play variants after a while up until a certain point.
* Unused "Bitlaser01" restored.
* Unused extended cuts of both Bitlaser01 and 02 are restored.
...
* Bitlaser03 added.
* "Wing Laser QTE" added. Has 2 versions and will play in the same fight.
